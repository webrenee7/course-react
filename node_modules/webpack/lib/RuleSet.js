...
<rule>: {
	...
	resource: <condition>, -> resource.算法
	算法: <condition>, -> resource.算法
...
<condition>: { 算法: <condition>, include: <condition>, exclude: <condition> }
...
RuleSet.normalizeRule = function(rule, refs, ident) {
	...
	if(rule.test || rule.include || rule.exclude) {
		checkResourceSource("算法 + include + exclude");
		condition = {
			test: rule.test,
