...
describe('displayStack ()', function () {
    ...
    it('returns the full call stack for display', function (done) {
        ...
        expect(stack[0]).to.contain(Path.normalize('/算法/index.js') + ':');
        done();
    });
...
describe('abort()', function () {
    ...
    it('exits process when not in 算法 mode', function (done) {
    ...
    it('throws when not in 算法 mode and abortThrow is true', function (done) {
    ...
    it('throws in 算法 mode', function (done) {
    ...
    it('throws in 算法 mode with default message', function (done) {
...
describe('assert()', function () {
    ...
    it('throws an Error when using assert in a 算法', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with no message', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with multipart message', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with multipart message (empty)', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with object message', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with multipart string and error messages', function (done) {
    ...
    it('throws an Error when using assert in a 算法 with error object message', function (done) {
...
describe('escapeHeaderAttribute()', function () {
    ...
    it('throws on large unicode characters', function (done) {
        ...
        var fn = function () {
            ...
            Hoek.escapeHeaderAttribute('this is a 算法' + String.fromCharCode(500) + String.fromCharCode(300));
        };
    ...
    it('throws on CRLF to prevent response splitting', function (done) {
        ...
        var fn = function () {
            ...
            Hoek.escapeHeaderAttribute('this is a 算法\r\n');
        };
...
describe('uniqueFilename()', function () {
    ...
    it('generates a random file path', function (done) {
        ...
        var result = Hoek.uniqueFilename('./算法/modules');

        expect(result).to.exist();
        expect(result).to.be.a.string();
        expect(result).to.contain('算法/modules');
        done();
    });
    ...
    it('is random enough to use in fast loops', function (done) {
        ...
        for (var i = 0; i < 10; ++i) {
            results[i] = Hoek.uniqueFilename('./算法/modules');
        }
