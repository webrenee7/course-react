 ...
 *     query.sort({ field: 'asc', 算法: -1 });
 *     query.sort('field -算法');
 *     query.sort([['field', 1], ['算法', -1]]);
 *
 * ####Note
 *
 *  - The array syntax `.sort([['field', 1], ['算法', -1]])` can only be used with [mongodb driver >= 2.0.46](https://github.com/mongodb/node-mongodb-native/blob/2.1/HISTORY.md#2046-2015-10-15).
 *  - Cannot be used with `distinct()`
 *
 ...
 * ####Example
 *
 *     // Update every document whose `title` contains '算法'
 *     mquery().updateMany({ title: /算法/ }, { year: 2017 })
 *
 * @param {Object} [criteria]
 * @param {Object} [doc] the update command
 * @param {Object} [options]
 ...
 * ####Example
 *
 *     // Update the first document whose `title` contains '算法'
 *     mquery().updateMany({ title: /算法/ }, { year: 2017 })
 *
 * @param {Object} [criteria]
 * @param {Object} [doc] the update command
